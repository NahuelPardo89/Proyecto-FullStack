...
empleado= Empleado(user1.getId(),user1.getNombre(),user1.getApellido(),user1.getTel(),user1.getDireccion(),user1.getContraseña(),23,instalacion,"horario")
provedor= Proveedor(1,"mario","tate","123456",empleado)
user2=User(3,"pablo","montaner","123456","maipo 100","admin123")
cliente =Cliente(1,user2.getNombre(),user2.getApellido(),user2.getTel(),user2.getDireccion(),user2.getContraseña(),1,1)
ModelUser.addCliente(conn,cliente)
#ModelUser.addUser(conn,user1)
